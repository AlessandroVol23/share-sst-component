...
export function physicalName(max, name, suffix = "") {
...
export function prefixName(max, name) {
    // This function does the following:
    // - Removes all non-alphanumeric characters
    // - Prefixes the name with the app name and stage
    // - Truncates the name if it's too long
...
export function hashNumberToPrettyString(number, length) {
...
export function hashStringToPrettyString(str, length) {
