...
export function buildApp(parent, name, args, sitePath, buildCommand) {
    return all([
        sitePath,
        ...
        function resolveBuildCommand() {
            ...
            if (!userCommand) {
                ...
                if (!packageJson.scripts || !packageJson.scripts.build) {
                    throw new VisibleError(`No "build" script found within package.json in "${sitePath}".`);
                }
            }
        ...
        function runBuild() {
            ...
            // Run build
            return siteBuilder(`${name}Builder`, {
                create: cmd,
                update: cmd,
